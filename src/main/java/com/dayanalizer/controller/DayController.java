...
public class DayController {
    ...
    @GetMapping
    public ResponseEntity<?> getDays(@RequestParam String email, @RequestParam String table, @RequestParam int year) {
        return ResponseEntity.ok().body(dayService.getDays(email, table, year));
    }
}
